...
fn get_default_help() -> String {
    ...
    help = format!("{help}{}", "   Create an aoc project in the current directory\n");
    ...
    help = format!("{help}{}", "    Add a new day to a year in the current aoc project\n\n");
        ...
        if cur_arg == "help" {
            if args.len() == 0 {
                ...
                if cur_arg == "new" {
                    ...
                    help = format!("{help}{}", "Create a new AOC project in the current directory\n\n");
                    help = format!("{help}{}", "Usage: ".bold().bright_green());
                    help = format!("{help}{}", "cargo aoc init".bold().bright_cyan());
                } else if cur_arg == "year" {
                    help = format!("{help}{}", "Add a new year to the AOC project in the current directory\n\n");
                    help = format!("{help}{}", "Usage: ".bold().bright_green());
                    ...
                    help = format!("{help}{}", "Add a new day to the specified year in the AOC project in the current directory\n\n");
                    help = format!("{help}{}", "Usage: ".bold().bright_green());
